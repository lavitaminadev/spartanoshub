...
let CrmHomeService = class CrmHomeService {
    constructor(leads, users, parametros) {
        this.leads = leads;
        this.users = users;
    ...
    async home(organizationId, coolingDays = 7, alcance = {}) {
        ...
        const diasParaParado = Number(await this.parametros.get(inactividad_del_lead_1.CLAVE_AVISO, null, null, organizationId) ?? inactividad_del_lead_1.PLAZOS_POR_DEFECTO.notice);
        ...
        const [delMes, ventasDelMes, montoDelMes, sinContactar, sinAsignar, calificadosSinVisita, parados, equipo] = await Promise.all([
            ...
            this.alert('parados', 'alto', this.soloLoSuyo({
                ...abierto,
                stageChangedAt: (0, typeorm_2.LessThan)(limiteParado),
            }, alcance.onlyAssignedTo)),
