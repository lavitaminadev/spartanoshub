...
export function PwaInstallButton() {
  ...
  return <button className="pwa-install-button" onClick={async () => { await promptEvent.prompt(); const choice = await promptEvent.userChoice; if (choice.outcome === 'accepted') setPromptEvent(null); }}><span>Instalar Espartanos</span><small>Usar como app en este equipo</small></button>;
}
