...
const TERMS = [
  { key: 'terms', label: 'Acepto los Terminos y Condiciones de uso de la plataforma Espartanos' },
...
export function ChangePasswordPage() {
  ...
  if (step === 'terms') {
    return <main className="auth-page"><section className="login-card password-card onboarding-card">
      ...
      <p>Todos los puntos son obligatorios para usar Espartanos.</p>
