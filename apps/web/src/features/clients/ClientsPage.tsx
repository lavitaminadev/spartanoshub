    ...
    <div className="page">
      ...
      <DataTable<ClientRecord>
        ...
        columns={[
          ...
          { key: 'industry', label: 'Rubro', sortable: true, render: (row) => industryLabel(row.industry) || '-' },
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <select className="input" value={form.industry} onChange={(e) => setForm({ ...form, industry: e.target.value })}>
              ...
              {CLIENT_INDUSTRIES.map((item) => <option key={item.value} value={item.value}>{item.label}</option>)}
            </select>
          </div>
