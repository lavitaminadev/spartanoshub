...
exports.JobsModule = JobsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [close_xp_periods_job_1.CloseXpPeriodsJob, create_monthly_cycles_job_1.CreateMonthlyCyclesJob, detect_stale_pieces_job_1.DetectStalePiecesJob, leads_parados_job_1.LeadsParadosJob, collection_emails_job_1.CollectionEmailsJob, purge_expired_leads_job_1.PurgeExpiredLeadsJob, meta_lead_recovery_job_1.MetaLeadRecoveryJob, operational_alerts_job_1.OperationalAlertsJob, recover_reservation_integrations_job_1.RecoverReservationIntegrationsJob, job_scheduler_service_1.JobSchedulerService],
        exports: [close_xp_periods_job_1.CloseXpPeriodsJob, create_monthly_cycles_job_1.CreateMonthlyCyclesJob, detect_stale_pieces_job_1.DetectStalePiecesJob, leads_parados_job_1.LeadsParadosJob, collection_emails_job_1.CollectionEmailsJob, purge_expired_leads_job_1.PurgeExpiredLeadsJob, meta_lead_recovery_job_1.MetaLeadRecoveryJob, operational_alerts_job_1.OperationalAlertsJob, recover_reservation_integrations_job_1.RecoverReservationIntegrationsJob],
    })
], JobsModule);
