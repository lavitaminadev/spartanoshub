...
export function AgendaPage() {
  ...
  const pausarReservas = useMutation({
    mutationFn: (hasta: string) => api.patch<ReservationForm>(`/reservations/forms/${effectiveFormId}/pause`, {
      until: hasta ? localInputToUtc(hasta, activeForm?.timezone || 'America/Santiago') : '',
    }),
