...
exports.ReservationGroupRequests1757800000000 = void 0;
class ReservationGroupRequests1757800000000 {
    constructor() {
        this.name = 'ReservationGroupRequests1757800000000';
    }
    ...
    async down(queryRunner) { if (await queryRunner.hasTable('reservation_group_requests'))
        await queryRunner.dropTable('reservation_group_requests'); }
}
exports.ReservationGroupRequests1757800000000 = ReservationGroupRequests1757800000000;
