...
</body></html>`),t.document.close(),t.onload=()=>{t.focus(),t.print()},!0}var _=t();function v({document:e,pdf:t=!0}){let[n,i]=(0,r.useState)(null),a=e.rows.length===0;return(0,_.jsxs)(`div`,{className:`export-botones`,children:[(0,_.jsx)(`button`,{type:`button`,className:`btn btn-outline btn-sm`,disabled:a,title:a?`No hay filas que exportar`:`Descargar como CSV`,onClick:()=>c(e),children:`Exportar CSV`}),t?(0,_.jsx)(`button`,{type:`button`,className:`btn btn-outline btn-sm`,disabled:a,title:a?`No hay filas que exportar`:`Abrir para imprimir o guardar como PDF`,onClick:()=>i(g(e)?null:`El navegador bloqueó la ventana. Permite las ventanas emergentes de este sitio.`),children:`Descargar PDF`}):null,n?(0,_.jsx)(`span`,{className:`export-aviso`,role:`alert`,children:n}):null]})}export{v as t};