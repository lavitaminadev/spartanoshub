...
exports.GetOpportunityUseCase = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const opportunity_entity_1 = require("../opportunity.entity");
let GetOpportunityUseCase = class GetOpportunityUseCase {
    constructor(repo) {
        this.repo = repo;
    }
    async execute(id, organizationId, allowedClientIds) {
...
exports.GetOpportunityUseCase = GetOpportunityUseCase;
exports.GetOpportunityUseCase = GetOpportunityUseCase = __decorate([
