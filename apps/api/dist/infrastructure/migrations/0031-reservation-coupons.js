...
exports.AddCoupons1710000000031 = void 0;
const typeorm_1 = require("typeorm");
class AddCoupons1710000000031 {
    constructor() {
        this.name = 'AddCoupons1710000000031';
    }
    async up(queryRunner) {
        ...
        if (!await queryRunner.hasColumn('reservations', 'coupon_code')) {
            await queryRunner.addColumn('reservations', new typeorm_1.TableColumn({ name: 'coupon_code', type: 'varchar', length: '80', isNullable: true }));
        }
    }
