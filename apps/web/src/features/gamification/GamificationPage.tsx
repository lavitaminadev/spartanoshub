...
export function GamificationPage() {
  ...
  return <div className="page gamification-page">
    ...
    {!users.length ? <EmptyState icon="trophy" title="La semana todavía no tiene movimientos" description="Los puntos aparecerán automáticamente cuando se registren entregas o ajustes autorizados." /> : <>
