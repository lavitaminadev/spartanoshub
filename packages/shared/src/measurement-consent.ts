...
export const VERSION_MEDICION = 'medicion-v2';

/** Frase corta del aviso al entrar. */
export const AVISO_MEDICION = '¿Nos ayudas a saber qué anuncios traen reservas? Con tu permiso usamos cookies de Meta y Google y les enviamos datos de tu reserva protegidos con cifrado. Tu reserva funciona igual si no aceptas.';
