...
export class CrmLeadAutomationService {
  ...
  /**
   * Crea el vínculo de la persona con su cuenta, o pone al día el que ya existe.
   *
   * La puesta al día es la parte que importa. El contacto guarda una copia del nombre, el
   * correo y el teléfono para poder leerlo sin cruzar tablas, y esa copia se quedaba congelada
   * con los datos del día en que se creó: si la persona corregía su teléfono en una reserva
   * posterior, el lead se actualizaba y el contacto no. A partir de ahí los dos registros
   * decían cosas distintas de la misma persona y nada avisaba cuál era la cierta.
   *
   * El lead manda siempre. Acá solo se refleja.
   */
