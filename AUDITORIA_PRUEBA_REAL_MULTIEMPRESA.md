...
8. **P0 — Portal podía listar toda la cartera de empresas.** Una sesión real de portal CRM recibió 12 empresas por `GET /clients?limit=100`, en vez de solo la asignada. Se añadió un alcance explícito por `req.user.clientId` y una regresión E2E; falta desplegar y repetir con el mismo portal antes de continuar el lote multiempresa.
