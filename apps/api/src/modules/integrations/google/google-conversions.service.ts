...
/**
 * Google exige formato internacional con `+` antes de hashear.
 *
 * Delega en la normalización común para que el mismo teléfono produzca la misma clave acá,
 * en el CRM y en Meta. La heurística anterior —"más de nueve dígitos ya es internacional"—
 * dejaba pasar sin prefijo un número de diez dígitos escrito sin código de país, y ese hash
 * no casa con nadie: Google acepta la conversión y no la atribuye.
 */
