...
/**
 * Cargos que alcanzan todas las cuentas de la agencia sin asignación.
 *
 * Son la administración y las cinco direcciones. Lo pide el Documento Maestro —"una CM ve
 * solo sus cuentas; un director ve todo"— y lo exigen sus propios tableros: dirección de
 * operaciones abre "estado de todas las cuentas" y dirección comercial necesita ocupación del
 * equipo y rentabilidad por cliente. Acotarlas por pod dejaba esas pantallas vacías.
 *
 * El resto del equipo —community managers, diseñadores, audiovisuales y el liderazgo de IA—
